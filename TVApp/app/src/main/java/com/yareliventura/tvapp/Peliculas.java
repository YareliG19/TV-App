...
public class Peliculas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EstructuraListview estructura_datos [] = new EstructuraListview[]{
                new EstructuraListview(R.mipmap.ic_tv, "Avengers: Age of Ultron"),
                new EstructuraListview(R.mipmap.ic_tv, "Jurassic World"),
                new EstructuraListview(R.mipmap.ic_tv, "Minions"),
                new EstructuraListview(R.mipmap.ic_tv, "Inside Out")
