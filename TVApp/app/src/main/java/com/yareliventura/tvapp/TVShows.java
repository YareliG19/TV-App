...
public class TVShows extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EstructuraListview estructura_datos [] = new EstructuraListview[]{
                new EstructuraListview(R.mipmap.ic_tv, "Vampire Diaries"),
                new EstructuraListview(R.mipmap.ic_tv, "Grey's Anatomy"),
                new EstructuraListview(R.mipmap.ic_tv, "The Bing Bang Theory"),
                new EstructuraListview(R.mipmap.ic_tv, "Game of Thrones")
